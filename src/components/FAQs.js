                    ...
                    {data.map(item => {
                        return (
                            <div className="max-w-[900px] bg-f1 rounded-md shadow-lg" key={item.id}>
                                ...
                                <div className={ selected === item.id ? 'px-4 py-4 transition-all duration-600 ease-linear h-auto max-h-[999px]' : 'px-4 max-h-0 transition-all duration-100 ease-linear overflow-hidden'}>
                                    <p>{item.answer}</p>
                                </div>
                            </div>    
                        )
