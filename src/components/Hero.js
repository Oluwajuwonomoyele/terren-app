        ...
        <section className="bg-customBlack h-[90vh] lg:h-[91vh] relative flex items-center">
            ...
            <div className="container mx-auto px-6 md:px-14 py-14 lg:py-28 text-white flex flex-col-reverse lg:flex-row gap-8 lg:justify-between items-center relative z-10">
               <div className='lg:basis-[60%]'>
                    ...
                    <p className='mt-4 xl:mt-8 leading-6 lg:text-lg' data-aos='fade-right'>Terren connects real estate companies and financial institutions, with the financial institutions investing in the real estate companies, thereby easing the generation of short-term capital and benefiting the financial institutions with higher returns on investment deposit.</p>
               </div>
