    ...
    return (  
        <section className="bg-customBlack">
            <div className="container mx-auto px-6 md:px-14 py-14 lg:py-28 flex flex-col lg:flex-row lg:justify-center gap-8 items-center">
                <div className="bg-lightGrey px-4 md:px-6 xl:py-0 text-center rounded-md md:max-w-[600px] lg:max-w-[400px] xl:max-w-[500px] h-[320px] lg:h-[300px] flex flex-col justify-center">
