        ...
        <section className="bg-customBlack text-white text-center relative">
            ...
            <div className="px-8 py-14 lg:py-28">
                ...
                <div className="mt-20 lg:mt-[10rem] flex flex-col lg:flex-row gap-8 items-center justify-center">
                    <div className="bg-darkGrey py-12 lg:py-0 px-8 rounded-md lg:max-w-[425px] h-[343px] lg:text-2xl flex flex-col justify-center">
                        <h3 className="mb-6 font-bold">BUY</h3>
                        <p>Buy as many units of real estate for as low as <b>#500</b> per unit.</p>
                    </div>
                    <div className="bg-lightGrey py-12 px-8 rounded-md text-customBlack lg:max-w-[425px] h-[343px] lg:text-2xl flex flex-col justify-center">
                    ...
                    <div className="bg-darkGrey py-12 px-8 rounded-md lg:max-w-[425px] h-[343px] lg:text-2xl flex flex-col justify-center">
                ...
                <h2 className="text-xl font-bold mt-8 lg:mt-36 lg:text-[42px]">Then do it all again</h2>
            </div>
        </section>
    );
}
